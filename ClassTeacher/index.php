      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="row">
            ...
            $query1=mysqli_query($conn,"SELECT COUNT(DISTINCT admissionNumber, dateTaken) as cnt FROM tblsubjectattendance WHERE classId = '$_SESSION[classId]' AND classArmId = '$_SESSION[classArmId]' AND status = '1'");

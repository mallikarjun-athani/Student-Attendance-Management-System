                  ...
                  <form method="post">
                    <div class="form-group row mb-3">
                        ...
                        <label class="form-control-label">Select Date<span class="text-danger ml-2">*</span></label>
                            <input type="date" class="form-control" name="dateTaken" id="exampleInputFirstName" placeholder="Semester Name" value="<?php echo htmlspecialchars($dateTaken); ?>">
                        </div>
                        <div class="col-xl-6">
                      ...
                      <input type="text" class="form-control" name="classArmName" value="<?php echo $row['classArmName'];?>" id="exampleInputFirstName" placeholder="Semester Name">
                        </div> -->
                    </div>

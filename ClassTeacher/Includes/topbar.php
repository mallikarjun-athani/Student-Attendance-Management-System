...
<nav class="navbar navbar-expand navbar-light topbar mb-4 static-top">
  <div class="d-flex align-items-center">
    ...
    <div class="ml-2 d-flex flex-column justify-content-center">
      <h4 class="font-weight-bold mb-0" style="color: var(--text-primary); font-size: 1rem; letter-spacing: -0.5px; line-height: 1.2;">SAMS <span style="color: var(--primary);">Teacher</span></h4>
    </div>
  </div>

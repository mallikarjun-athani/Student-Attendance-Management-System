...
$whereStudents = " WHERE s.classId = '".$conn->real_escape_string($_SESSION['classId'])."' AND s.classArmId = '".$conn->real_escape_string($_SESSION['classArmId'])."' ";
if ($selectedClassId !== '') {
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Today Attendance Summary</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Today Attendance Summary</li>
            </ol>
          </div>
          ...
          <div class="row mb-3">
            <div class="col-lg-12 d-flex align-items-center justify-content-between" style="gap:12px; flex-wrap:wrap;">
              <div class="d-flex align-items-center" style="gap:10px; flex-wrap:wrap;">
                <a href="viewAttendance.php" class="btn btn-outline-secondary">View Class Attendance</a>
              </div>

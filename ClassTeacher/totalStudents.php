...
$countWhere = '';
if ($selectedClassId !== '') {
  $countWhere = " AND classId = '".intval($selectedClassId)."'";
}

$qStudents = mysqli_query($conn,"SELECT * from tblstudents where classArmId = '$_SESSION[classArmId]'".$countWhere);
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Total Students</li>
            </ol>
          </div>
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive table-cards p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody>
                      <?php
                        $where = " WHERE s.classArmId = '".intval($_SESSION['classArmId'])."' ";
                        if ($selectedClassId !== '') {
                          $where .= ' AND s.classId = '.intval($selectedClassId).' ';
                        }
